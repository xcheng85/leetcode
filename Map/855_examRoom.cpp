// set with custom class definition
...
struct IntV
{
    ...
    // overload sorting criteria, return the largest interval
...
class ExamRoom
{
  public:
    set<IntV> tab;
    map<int, int> l2r, r2l; // next right, like double linked list
    ...
    int seat()
    {
        ...
        // insert one , create two interval 
        int pos = cur.getP();
