// standard bit example
// update and query is no special

// sort the array, so we know we can use the position of sorted array integer to get the inversion relation ships
